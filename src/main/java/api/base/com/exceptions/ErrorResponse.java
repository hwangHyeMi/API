...
public class ErrorResponse {
	 ...
	 */
	@Builder
	protected ErrorResponse(final HttpStatus status, final String resultMsg, final String prefixCode) {
		this.resultMsg = resultMsg;
		this.status = status.value();
		this.divisionCode = prefixCode + status.series().value();
	 ...
	 */
	@Builder
	protected ErrorResponse(final ErrorCode code, final String reason, final String resultMsg) {
		this.resultMsg = resultMsg;
		this.status = code.getStatus();
		this.divisionCode = code.getDivisionCode();
		//this.reason = reason;
	 ...
	 * @return
	 */
	public static ErrorResponse of(final HttpStatus status, final String resultMsg, final String prefixCode) {
		return new ErrorResponse(status, resultMsg, prefixCode);
	}
	...
	/**
	 * Global Exception 전송 타입-4
	 *
	 * @param code ErrorCode
	 * @param reason String
	 * @return ErrorResponse
	 */
	public static ErrorResponse of(final ErrorCode code, final String reason, final String resultMsg) {
		return new ErrorResponse(code, reason, resultMsg);
	}
