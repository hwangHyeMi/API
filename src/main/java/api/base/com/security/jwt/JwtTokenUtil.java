...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(CustomUserDetails userDetails) {
        ...
        claims.put("mbrSeq", userDetails.getMbrSeq());
        claims.put("groupCode", userDetails.getGroupCode());
        claims.put("mbrKey", userDetails.getMbrKey());
        claims.put("mbrAuthorities", userDetails.getMbrAuthorities());
        return doGenerateToken(claims, userDetails.getUsername());
    }
