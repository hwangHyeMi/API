          ...
          <div className="row">
            <div className="col-xl-3 col-md-6">
              <div className="card bg-primary text-white mb-4">
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <a className="small text-white stretched-link" href={HOME_PATH + '/11/hm/DevSearchList'}>
                    View Details
                  </a>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-warning text-white mb-4">
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <a className="small text-white stretched-link" href={HOME_PATH + '/11/sj/DevAssembl'}>
                    View Details
                  </a>
                  <div className="small text-white">
                    <i className="fas fa-angle-right"></i>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-success text-white mb-4">
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <a className="small text-white stretched-link" href={HOME_PATH + '/11/dev/TodoList'}>
                    View Details
                  </a>
                  <div className="small text-white">
                    <i className="fas fa-angle-right"></i>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="card bg-danger text-white mb-4">
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <a className="small text-white stretched-link" href={HOME_PATH + '/11/sj/DevListScroll'}>
                    View Details
                  </a>
                  <div className="small text-white">
                    <i className="fas fa-angle-right"></i>
