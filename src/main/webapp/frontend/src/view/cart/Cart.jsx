...
const Cart = () => {
  const { cartItems, food_list, removeFromCart, getTotalCartAmount, getTotalQuantity } = useContext(ContextStore);
    ...
    <div className="cart">
              ...
              return (
                <React.Fragment key={item._id}>
                  <div className="cart-items-title cart-items-item" key={item._id}>
                    ...
                    <p>{(item.price * cartItems[item._id]).toLocaleString('ko-KR')}</p>
      ...
      <div className="cart-bottom">
        <div className="cart-total">
          ...
          <div>
            <button disabled={getTotalCartAmount() === 0} onClick={() => navigate('/order')}>
              CHECKOUT
            </button>
            &nbsp;&nbsp;
